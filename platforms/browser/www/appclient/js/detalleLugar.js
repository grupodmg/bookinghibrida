function cargarTipoLugar(fn) {
    httpConnect("http://192.168.0.12:88/tipolugar", null, "GET", function (r) {
...
function cargarMunicipio(fn) {
    httpConnect("http://192.168.0.12:88/Municipio", null, "GET", function (r) {
...
function cargarDetalle() {
    ...
    httpConnect("http://192.168.0.12:88/lugar/" + id, null, "GET", function (r) {
        if (r.status !== 200) {
            alert(r.message);
...
$(function () {
    ...
    $("#frmUpdate").submit(function () {
        ...
        var id = $("#id").val();
        httpConnect("http://192.168.0.12:88/lugar/" + id, jentidad, "PUT", function (r) {
            alert(r.message );
            window.location.replace("?p=listarLugar");
        });
        return false;
